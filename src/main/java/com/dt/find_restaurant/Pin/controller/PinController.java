...
public class PinController {
    ...
    @PostMapping
    public PinEntity createPin(@Validated PinRequest pinRequest) {
    ...
    @GetMapping("/{pinId}")
    public PinEntity getPinById(@RequestParam UUID pinId) {
